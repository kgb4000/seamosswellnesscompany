    ...
    <>
      ...
      <section>
        <div className="terms-container">
          ...
          <h2>OVERVIEW</h2>
          <p>This website is operated by Sea Moss Wellness Company.</p>
          <p>
            Throughout this website, the terms “we”, “us” and “our” refer to Sea
            Moss Wellness Company. Sea Moss Wellness Company offers this
            website, and all information, tools and services available from this
            site to you, the user, conditioned upon your acceptance of all
            terms, conditions, policies and notices stated here.
          </p>
          <p>
            By visiting Sea Moss Wellness Company website and/ or purchasing
          ...
          <h2>SECTION 1 - ONLINE STORE TERMS</h2> By agreeing to these Terms of
          ...
          or otherwise affect these Terms. SECTION 3 - ACCURACY, COMPLETENESS
          AND TIMELINESS OF INFORMATION We are not responsible if information
          made available on this site is not accurate, complete or current. The
          ...
          current and is provided for your reference only. We reserve the right
          to modify the contents of this site at any time, but we have no
          obligation to update any information on our site. You agree that it is
          your responsibility to monitor changes to our site. SECTION 4 -
          ...
          applicable) Certain products or services may be available exclusively
          ...
          according to our Return Policy. We have made every effort to display
          ...
          not obligated, to limit the sales of our products or Services to any
          ...
          that any errors in the Service will be corrected. SECTION 6 - ACCURACY
          OF BILLING AND ACCOUNT INFORMATION We reserve the right to refuse any
          ...
          contact you as needed. For more detail, please review our Returns
          Policy. SECTION 7 - OPTIONAL TOOLS We may provide you with access to
          ...
          these Terms of Service. SECTION 8 - THIRD-PARTY LINKS Certain content,
          ...
          Policy. To view our Privacy Policy. SECTION 11 - ERRORS, INACCURACIES
          AND OMISSIONS Occasionally there may be information on our site or in
          ...
          any related website for violating any of the prohibited uses. SECTION
          ...
          case shall Sea Moss Wellness Company, our directors, officers,
          ...
          shall be limited to the maximum extent permitted by law. SECTION 14 -
          INDEMNIFICATION You agree to indemnify, defend and hold harmless
          Organics Nature and our parent, subsidiaries, affiliates, partners,
          ...
          violation of any law or the rights of a third-party. SECTION 15 -
          ...
          provisions. SECTION 16 - TERMINATION The obligations and liabilities
          of the parties incurred prior to the termination date shall survive
          the termination of this agreement for all purposes. These Terms of
          Service are effective unless and until terminated by either you or us.
          ...
          against the drafting party. SECTION 18 - GOVERNING LAW These Terms of
          Service and any separate agreements whereby we provide you Services
          shall be governed by and construed in accordance with the laws of
          United States. SECTION 19 - CHANGES TO TERMS OF SERVICE You can review
          ...
          <p>Terms of Service constitutes acceptance of those changes.</p>
          <h2>SECTION 20 - CONTACT INFORMATION</h2>
          <p>
            Questions about the Terms of Service should be sent to us at
            support@seamosswellnessco.com SMS/MMS MOBILE MESSAGE MARKETING
            PROGRAM TERMS AND CONDITIONS Sea Moss Wellness Company (hereinafter,
            “We,” “Us,” “Our”) is offering a mobile messaging program (the
            “Program”), which you agree to use and participate in subject to
            these Mobile Messaging Terms and Conditions and Privacy Policy
            https://www.seamosswellnessco.com/privacy-policy/ (the “Agreement”).
          </p>
          <p>
            By opting in to or participating in any of our Programs, you accept
          ...
          This Agreement is limited to the Program and is not intended to modify
          other Terms and Conditions or Privacy Policy that may govern the
          relationship between you and Us in other contexts. User Opt-In: The
          Program allows Users to receive SMS/MMS mobile messages by
          ...
          Program, you agree to receive autodialed or prerecorded marketing
          ...
          apply. Message frequency varies.  User Opt Out: If you do not wish to
          continue participating in the Program or no longer agree to this
          Agreement, you agree to reply STOP, END, CANCEL, UNSUBSCRIBE, or QUIT
          to any mobile message from Us in order to opt out of the Program. You
          may receive an additional mobile message confirming your decision to
          opt out. You understand and agree that the foregoing options are the
          only reasonable methods of opting out. You acknowledge that our text
          ...
          addition of other words or phrases to the command, and agree that
          Organics Nature and its service providers will have no liability for
          failing to honor such requests. You also understand and agree that any
          other method of opting out, including, but not limited to, texting
          words other than those set forth above or verbally requesting one of
          our employees to remove you from our list, is not a reasonable means
          of opting out. Program Description: Without limiting the scope of the
          Program, users that opt into the Program can expect to receive
          messages concerning the marketing, promotion, payment, delivery and
          sale of digital and physical products, services. Messages may include
          checkout reminders.  Cost and Frequency: Message and data rates may
          apply. You agree to receive messages periodically at Our discretion.
          Daily, weekly, and monthly message frequency will vary. The Program
          involves recurring mobile messages, and additional mobile messages may
          be sent periodically based on your interaction with Us. Support
          Instructions: For support regarding the Program, text “HELP” to the
          number you received messages from or email us at
          support@organicsnature.co. Please note that the use of this email
          address is not an acceptable method of opting out of the program. Opt
          outs must be submitted in accordance with the procedures set forth
          above. MMS Disclosure: The Program will send SMS TMs (terminating
          messages) if your mobile device does not support MMS messaging. Our
          Disclaimer of Warranty: The Program is offered on an "as-is" basis and
          may not be available in all areas at all times and may not continue to
          work in the event of product, software, coverage or other changes made
          by your wireless carrier. We will not be liable for any delays or
          failures in the receipt of any mobile messages connected with this
          Program. Delivery of mobile messages is subject to effective
          transmission from your wireless service provider/network operator and
          is outside of Our control. Carriers are not liable for delayed or
          undelivered mobile messages. Participant Requirements: You must have a
          ...
          with text messaging service. Not all cellular phone providers carry
          the necessary service to participate. Check your phone capabilities
          for specific text messaging instructions. Age Restriction: You may not
          use or engage with the Platform if you are under thirteen (13) years
          of age. If you use or engage with the Platform and are between the
          ages of thirteen (13) and eighteen (18) years of age, you must have
          your parent’s or legal guardian’s permission to do so. By using or
          engaging with the Platform, you acknowledge and agree that you are not
          under the age of thirteen (13) years, are between the ages of thirteen
          (13) and eighteen (18) and have your parent’s or legal guardian’s
          permission to use or engage with the Platform, or are of adult age in
          your jurisdiction. By using or engaging with the Platform, you also
          acknowledge and agree that you are permitted by your jurisdiction’s
          Applicable Law to use and/or engage with the Platform. Prohibited
          Content: You acknowledge and agree to not send any prohibited content
          over the Platform. Prohibited content includes: - Any fraudulent,
          libelous, defamatory, scandalous, threatening, harassing, or stalking
          activity; - Objectionable content, including profanity, obscenity,
          lasciviousness, violence, bigotry, hatred, and discrimination on the
          basis of race, sex, religion, nationality, disability, sexual
          orientation, or age; - Pirated computer programs, viruses, worms,
          Trojan horses, or other harmful code; - Any product, service, or
          promotion that is unlawful where such product, service, or promotion
          thereof is received; - Any content that implicates and/or references
          ...
          jurisdiction from which the message is sent.   Dispute Resolution: In
          the event that there is a dispute, claim, or controversy between you
          and Us, or between you and Stodge Inc. d/b/a Postscript or any other
          ...
          relating to federal or state statutory claims, common law claims, this
          ...
          determined by arbitration in Reisterstown, MD before one arbitrator.
          ...
          the Federal Judicial Circuit in which Sea Moss Wellness Company’s
          ...
          who has knowledge of and experience with the subject matter of the
          dispute. If the parties do not agree on an arbitrator within ten (10)
          calendar days, a party may petition the AAA to appoint an arbitrator,
          who must satisfy the same experience requirement. In the event of a
          dispute, the arbitrator shall decide the enforceability and
          interpretation of this arbitration agreement in accordance with the
          Federal Arbitration Act (“FAA”). The parties also agree that the AAA’s
          rules governing Emergency Measures of Protection shall apply in lieu
          of seeking emergency injunctive relief from a court. The decision of
          the arbitrator shall be final and binding, and no party shall have
          rights of appeal except for those provided in section 10 of the FAA.
          Each party shall bear its share of the fees paid for the arbitrator
          and the administration of the arbitration; however, the arbitrator
          shall have the power to order one party to pay all or any portion of
          such fees as part of a well-reasoned decision. The parties agree that
          the arbitrator shall have the authority to award attorneys’ fees only
          to the extent expressly authorized by statute or contract. The
          ...
          CAPACITY VIA ARBITRATION AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY
          PURPORTED CLASS OR REPRESENTATIVE ARBITRATION PROCEEDING. Further,
          unless both parties agree otherwise in a signed writing, the
          ...
          arbitration without the prior written consent of both parties, unless
          to protect or pursue a legal right. If any term or provision of this
          ...
          unenforceable such term or provision in any other jurisdiction. If for
          any reason a dispute proceeds in court rather than in arbitration, the
          parties hereby waive any right to a jury trial. This arbitration
          provision shall survive any cancellation or termination of your
          agreement to participate in any of our Programs. Florida Law: We
          endeavor to comply with the Florida Telemarketing Act and the Florida
          Do Not Call Act as applicable to Florida residents. For purposes of
          compliance, you agree that we may assume that you are a Florida
          resident if, at the time of opt-in to Program, (1) your shipping
          address, as provided is located in Florida or (2) the area code for
          the phone number used to opt-into the Program is a Florida area code.
          You agree that the requirements of the Florida Telemarketing Act and
          the Florida Do Not Call Act do not apply to you, and you shall not
          assert that you are a Florida resident, if you do not meet either of
          these criteria or, in the alternative, do not affirmatively advise us
          in writing that you are a Florida resident by sending written notice
          to us. Insofar as you are a Florida resident, you agree that mobile
          messages sent by Us in direct response to mobile messages or requests
          from You (including but are not limited to response to Keywords,
          opt-in, help or stop requests and shipping notifications) shall not
          constitute a “telephonic sales call” or “commercial telephone
          solicitation phone call” for purposes of Florida Statutes Section 501
          (including but not limited to sections 501.059 and 501.616), to the
          extent the law is otherwise relevant and applicable. Miscellaneous:
          ...
          waiver of any further rights hereunder. If any provision of this
          ...
          enforceable.
          <p>
            Any new features, changes, updates or improvements of the Program
          ...
          <p>Any updates to this Agreement shall be communicated to you.</p>
          <p>
            You acknowledge your responsibility to review this Agreement from

  ...
  return (
    <>
      ...
      <div className="container content">
        ...
        <p>
          We believe in nourishing our bodies with whole foods that are rich in
          minerals, vitamins, and other essential nutrients.
        </p>
        <p>
        ...
        <p>
          Our product selection includes sea moss gel, teas, capsules and other
          natural supplements.
        </p>
        <p>
          We believe that nature has all the answers when it comes to health and
          beauty, and our goal is to provide natural alternatives for those
          looking to achieve their own unique level of wellness.
        </p>
        <p>
          Our products are carefully curated from sustainable sources and
          crafted with love in order to bring you the best possible experience.
        ...
        <p>
          We hope our products will help you achieve a greater level of wellness
          and beauty.
        </p>
        <p>Best wishes,</p>
        <img src="" />
